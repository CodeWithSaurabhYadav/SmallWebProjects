            ...
            try {
                ...
                if ($pass1 != $pass2) {
                    ...
                    try {
                        ...
                        <a href="/" class="goTo" id="failedTxt" style="font-size: 24px;text-transform: uppercase;padding: 0.5rem 1rem;border-radius: 6px;color: #EBF0F5;background-color: #FF1A1A;border=none;">Regiser again</a>';
                    }
                }
            } catch (Exception $ë) {
